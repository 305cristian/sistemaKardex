        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="idFormInsertar" class="container" action="<?php echo base_url() ?>Admin_controller/insertarMarca">
                            <div class="row">
...
<script>
    ...
    $('#idTblMarcas').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url(); ?>Admin_Controller/obtenerMarca',
            data: {id: id},
            dataType: 'json',
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'ajax',
                    method: 'post',
                    url: "<?php echo base_url(); ?>Admin_controller/eliminarMarca",
                    data: {id: id},
                    success: function (response) {
                        if (response) {
    ...
    function mostrarMarcas() {
        ...
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>Admin_controller/obtenerMarcas",
            dataType: 'json',
