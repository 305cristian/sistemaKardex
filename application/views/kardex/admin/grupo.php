        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="idFormInsertar" class="container" action="<?php echo base_url() ?>Admin_controller/insertarGrupo">
                            <div class="row">
            ...
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                <form id="idFormInsertarSub" class="container" action="<?php echo base_url() ?>Admin_controller/insertarSubGrupo">
                                    <div class="row">
...
//    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response) {
                    ...
                    mostrarGrupos(); //actualizamos la tabla marcas
    ...
    $('#idTblGrupo').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url(); ?>Admin_Controller/obtenerGrupo',
            data: {id: id},
            dataType: 'json',
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'ajax',
                    method: 'post',
                    url: "<?php echo base_url(); ?>Admin_controller/eliminarGrupo",
                    data: {id: id},
                    success: function (response) {
                        if (response) {
    ...
    function mostrarGrupos() {
        ...
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>Admin_controller/obtenerGrupos",
            dataType: 'json',
...
//        var fk = $('#idComboGrupo').val();
    ...
    $('#idTblSubGrupo').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url(); ?>Admin_controller/obtenerSubgrupo',
            data: {id: id},
            dataType: 'json',
            success: function (data) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'ajax',
                    method: 'post',
                    url: '<?php echo base_url() ?>Admin_controller/eliminarSubgrupo',
                    data: {id: id},
                    dataType: 'json',
    ...
    function mostrarSubGrupos() {
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>Admin_controller/obtenerSubGrupos",
            dataType: 'json',
            success: function (data) {
                if (data) {
