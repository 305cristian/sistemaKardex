        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="idFormInsertar" class="container" action="<?php echo base_url() ?>Admin_controller/insertarTipo">
                            <div class="row">
...
<script>
    ...
    $('#idTbltipo').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo base_url(); ?>Admin_Controller/obtenerTipo',
            data: {id: id},
            dataType: 'json',
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'ajax',
                    method: 'post',
                    url: "<?php echo base_url(); ?>Admin_controller/eliminarTipo",
                    data: {id: id},
                    success: function (response) {
                        if (response) {
    ...
    function mostrarMarcas() {
        ...
        $.ajax({
            type: 'ajax',
            url: "<?php echo base_url() ?>Admin_controller/obtenerTipos",
            dataType: 'json',
