        ...
        <div class="row">                      
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second ">
                    ...
                    <div class=" btnEnlace mt-3">
                        <a href="<?php echo base_url() ?>Admin_controller" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    ...
                    <div class=" btnEnlace mt-3">
                        <a href="<?php echo base_url() ?>Comp_controller" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    ...
                    <div class=" btnEnlace mt-3">
                        <a href="<?php echo base_url() ?>Vent_controller" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    ...
                    <div class=" btnEnlace mt-3">
                        <a href="<?php echo base_url() ?>Inv_controller" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
                </div>
