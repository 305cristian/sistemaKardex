...
<div class="content-wrapper mt-5">
    <div class="content-header container text-center col-sm-12 mt-3">
        <div class="row">                      
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    <div class="thumbnail">
                        <span><i class="fas fa-folder-open fa-4x"></i></span>
                        <h5>INVENTARIO</h5>                                
                    </div>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    <div class="thumbnail">
                        <span><i class="fas fa-exchange-alt fa-4x"></i></span>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    <div class="thumbnail">
                        <span><i class="fas fa-sort-amount-up fa-4x"></i></span>
                        <h5>AJUSTES DE ENTRADA</h5>                                
                    </div>
                    <div class=" btnEnlace mt-3">
                        <a href="" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
            ...
            <div class="col-sm-12 col-md-3">
                <div class=" cont-second">
                    <div class="thumbnail">
                        <span><i class="fas fa-sort-amount-down-alt fa-4x"></i></span>
                        <h5>AJUSTES DE SALIDA</h5>                                
                    </div>
                    <div class=" btnEnlace mt-3">
                        <a href="" class="link">Acceder al modulo  <span><i class="fas fa-arrow-circle-right"></i></span></a>
                    </div>
