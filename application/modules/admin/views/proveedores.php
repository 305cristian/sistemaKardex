        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="formulario" action="<?php echo base_url() ?>admin/Admin_controller/insertarProveedor">
...
//                    $('#idTblProveedores').DataTable().destroy();
    ...
    $('#idTblProveedores').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/mostrarProveedor',
            data: {id: id},
            dataType: 'json',
    ...
    function cargarProveedores() {
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerProveedores',
            dataType: 'json',
            success: function (data, textStatus, jqXHR) {
