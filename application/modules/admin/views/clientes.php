<div id='app' class="content-wrapper content-header mt-5">
                ...
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="idFormModificar" class="container" action="">
                            ...
                            <div class="row">
                                <label>Selecione el genero</label>
                                <select id="idGenero2" class="form-control" v-model='actualizarCliente.cli_genero'>
                                    <option disabled value="0">Selecione un genero</option>
                                    <option>Masculino</option>
                                    <option>Femenino</option>                               
                                </select>
                            </div>  
