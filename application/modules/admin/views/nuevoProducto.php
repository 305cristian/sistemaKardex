        ...
        <div class=" modal-dialog modal-lg">
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-body">
                        <form id="idFormulario" action="<?php echo base_url(); ?>admin/Admin_controller/insertarProducto">
                            <div class="row">
                                <div class="col-sm-4">
...
<script>
    ...
    function cargarMarca() {
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerMarcasAtv',
            dataType: 'json',
...
//                    var registro=eval(response)
    ...
    function cargarTipo() {
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerTipoAtv',
            dataType: 'json',
            success: function (response) {
                if (response) {
//                    var registro=eval(response)
    ...
    function cargarGrupo() {
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerGrupoAtv',
            dataType: 'json',
            success: function (response) {
                if (response) {
//                    var registro=eval(response)
    ...
    function cargarSubGrupo(fkG) {//Recivo el id de Grupo por parametros
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerSubGrupoAtv',
            data: {fk: fkG},
            dataType: 'json',
            success: function (response) {
                var cuerpoCombo = '';
...
//Selecionamos el grupo y se acuerdo a la selecion cargamos el subgrupo 
    ...
    $('#idTblProductos').on('click', '.item-edit', function () {
        ...
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: '<?php echo base_url() ?>admin/Admin_controller/obtenerProducto',
            data: {id: id},
            dataType: 'json',
...
//                cargarSubGrupo(data.fkGrupo);
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: 'ajax',
                    method: 'post',
                    url: '<?php echo base_url() ?>admin/Admin_controller/eliminarProducto',
                    data: {id: id},
                    dataType: 'json',
    ...
    function cargarProductos() {
        $.ajax({
            type: 'ajax',
            method: 'post',
            url: "<?php echo base_url() ?>admin/Admin_controller/obtenerProductos",
            dataType: 'json',
